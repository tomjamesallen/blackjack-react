 ...
 */
var DeckManager = function(options) {
  ...
  var api = {
    ...
    newDeck(numPacks) {
      ...
      var numPacks = numPacks || op.packsPerDeck;
    ...
    dealCard() {
      ...
      var nextCardId = deckOrder[deck.dealt];
      
      // Get the card.
      var card = deck.cards[nextCardId];
    ...
    _createDeckOrder() {
      ...
      var availableIds = range(0, deckLength);
